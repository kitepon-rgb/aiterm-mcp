...
- ✅ main CI `32664712823`とtag CI／Trusted Publishing `32664978268`はself-hosted 4環境同一fullがgreen。
- ✅ npm provenance 0.28.0、GitHub Release＋MCPB、Official Registry workflow `32664978093`、
