---
title: "Harbor Framework: Terminus-2 reference agent"
source_url: "https://www.harborframework.com/docs/agents/terminus-2"
source_type: docs
fetched: 2026-06-01
topic: prior-art
tags: ["harbor", "terminus-2", "tmux", "single-tool", "keystrokes", "docker", "reference-agent"]
summary: "Terminus-2リファレンスエージェントの公式ドキュメント。tmuxセッション1個でキー送信・出力スクロール・メニュー操作を行い、Docker環境とは別プロセスで動く構成を説明。"
relevance: "local→ssh→docker のネスト送信モデルに近い「別プロセスからtmux経由で対象環境を駆動」する設計の実例。"
chars: 20947
---
...
[docs](/docs)[news](/news)[hub](https://hub.harborframework.com)[discord](https://discord.gg/6xWPKhGDbA)[Motivation](/docs)[Getting Started](/docs/getting-started)[Core Concepts](/docs/core-concepts)[Migrating from Terminal-Bench](/docs/migration)
...
[Agents](/docs/agents)[Terminus-2](/docs/agents/terminus-2)[Agent Trajectory Format (ATIF)](/docs/agents/trajectory-format)
...
### [Mono-tool Design](#mono-tool-design)
...
### [Autonomy-First Approach](#autonomy-first-approach)
...
## [Using Terminus-2 with Harbor](#using-terminus-2-with-harbor)
...
### [Standard Summarization Process](#standard-summarization-process)
...
### [Passive Summarization](#passive-summarization)
...
### [Rollout Details Collection](#rollout-details-collection)
...
### [Trajectory Configuration](#trajectory-configuration)
...
Using popular agents and integrating your own](/docs/agents)[Agent Trajectory Format (ATIF)

Understanding and working with the Agent Trajectory Interchange Format](/docs/agents/trajectory-format)

### On this page

[Overview](#overview)[Key Features](#key-features)[Mono-tool Design](#mono-tool-design)[Independent Execution](#independent-execution)[Autonomy-First Approach](#autonomy-first-approach)[Using Terminus-2 with Harbor](#using-terminus-2-with-harbor)[Basic Usage](#basic-usage)[Configuration Options](#configuration-options)[Conversation History Management](#conversation-history-management)[Standard Summarization Process](#standard-summarization-process)[Proactive Summarization](#proactive-summarization)[Passive Summarization](#passive-summarization)[Reinforcement Learning Support](#reinforcement-learning-support)[Rollout Details Collection](#rollout-details-collection)[Token Information](#token-information)[Rewards](#rewards)[Trajectory Format](#trajectory-format)[Trajectory Configuration](#trajectory-configuration)[Configuration Options](#configuration-options-1)[Example Configuration](#example-configuration)[Related Documentation](#related-documentation)
