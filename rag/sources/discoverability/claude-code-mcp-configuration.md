...
summary: "Claude Codeにstdio MCPサーバーを登録する公式手順。"
relevance: "READMEのClaude Code向け設定例の一次資料。"
chars: 81109
---
...
* [Quickstart](/docs/en/mcp-quickstart)
* [Reference](/docs/en/mcp)
...
* [Monorepos and large repos](/docs/en/large-codebases)
