---
title: "Cursor CLI Agent Client Protocol"
source_url: "https://prod.cursor.com/docs/cli/acp"
source_type: official_docs
fetched: 2026-08-24
topic: completion-detection
tags: ["cursor", "acp", "stdio", "session", "completion"]
summary: "Cursor Agent CLIをACP serverとして起動し、構造化session/promptで操作する公式仕様。"
relevance: "TUI adapterと比較する構造化persistent harness経路、および将来のdone境界候補。"
chars: 35626
---
...
## [Start ACP server](#start-acp-server)
...
## [Transport and message format](#transport-and-message-format)
...
## [Sessions, modes, and permissions](#sessions-modes-and-permissions)
...
### [`cursor/ask_question`](#cursorask_question)
...
### [`cursor/create_plan`](#cursorcreate_plan)
...
### [`cursor/update_todos`](#cursorupdate_todos)
...
### [`cursor/generate_image`](#cursorgenerate_image)
...
## [Minimal Node.js client](#minimal-nodejs-client)
...
### [Neovim (avante.nvim)](#neovim-avantenvim)
...
Manage and use MCP servers from Cursor CLI](/docs/cli/mcp)[MCP Overview

Learn MCP transports, configuration, and server setup](/docs/mcp)
...
* [MCP servers](#mcp-servers)
* [Cursor extension methods](#cursor-extension-methods)
* [cursor/ask\_question](#cursorask_question)
* [cursor/create\_plan](#cursorcreate_plan)
* [cursor/update\_todos](#cursorupdate_todos)
* [cursor/task](#cursortask)
* [cursor/generate\_image](#cursorgenerate_image)
* [Minimal Node.js client](#minimal-nodejs-client)
* [IDE integrations](#ide-integrations)
* [Example use cases](#example-use-cases)
* [Neovim (avante.nvim)](#neovim-avantenvim)
