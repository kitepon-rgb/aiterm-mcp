---
title: "Terminal Shell Integration (Roo Code) — markers + fallback"
source_url: "https://roocodeinc.github.io/Roo-Code/features/shell-integration"
source_type: docs
fetched: 2026-06-01
topic: completion-detection
tags: ["agent", "osc-633", "osc-133", "fallback", "timeout", "exit-code"]
summary: "AIエージェントがVS Codeシェル統合マーカーで完了/exit codeを検出し、統合が無い時はbackground実行へフォールバックする設計。"
relevance: "マーカー方式が効かない時(=ネスト/SSH想定)にtimeout/別経路へ落とす実運用フォールバック設計。検出失敗時の退避策の参考。"
chars: 34111
---

[Skip to main content](#__docusaurus_skipToContent_fallback)

[![Roo Code Logo](/Roo-Code/img/roo-code-logo-dark.svg)![Roo Code Logo](/Roo-Code/img/roo-code-logo-white.svg)](/Roo-Code/)

[15.4k](https://github.com/RooCodeInc/Roo-Code "GitHub Repository")[Install ·574.1k](https://marketplace.visualstudio.com/items?itemName=RooVeterinaryInc.roo-cline "Install VS Code Extension")

* [Welcome](/Roo-Code/)
* [Roo Code VSCode Extension](/Roo-Code/getting-started/installing)

  + [Installing Roo Code](/Roo-Code/getting-started/installing)
  + [Connecting To AI Provider](/Roo-Code/getting-started/connecting-api-provider)
  + [Your First Task](/Roo-Code/getting-started/your-first-task)
  + [The Chat Interface](/Roo-Code/basic-usage/the-chat-interface)
  + [Typing Your Requests](/Roo-Code/basic-usage/typing-your-requests)
  + [How Tools Work](/Roo-Code/basic-usage/how-tools-work)
  + [Context Mentions](/Roo-Code/basic-usage/context-mentions)
  + [Using Modes](/Roo-Code/basic-usage/using-modes)
  + [Tips & Tricks](/Roo-Code/tips-and-tricks)
  + [Reporting Errors](/Roo-Code/reporting-errors)
  + [Features](/Roo-Code/features/api-configuration-profiles)

    - [API Configuration Profiles](/Roo-Code/features/api-configuration-profiles)
    - [Auto-Approving Actions](/Roo-Code/features/auto-approving-actions)
    - [Boomerang Tasks](/Roo-Code/features/boomerang-tasks)
    - [Checkpoints](/Roo-Code/features/checkpoints)
    - [Code Actions](/Roo-Code/features/code-actions)
    - [Codebase Indexing](/Roo-Code/features/codebase-indexing)
    - [Custom Instructions](/Roo-Code/features/custom-instructions)
    - [Diagnostics Integration](/Roo-Code/features/diagnostics-integration)
    - [Customizing Modes](/Roo-Code/features/custom-modes)
    - [Enhance Prompt](/Roo-Code/features/enhance-prompt)
    - [Import/Export/Reset Settings](/Roo-Code/features/settings-management)
    - [Intelligent Context Condensing](/Roo-Code/features/intelligent-context-condensing)
    - [Keyboard Navigation](/Roo-Code/features/keyboard-shortcuts)
    - [Roo Code Marketplace](/Roo-Code/features/marketplace)
    - [Message Queueing](/Roo-Code/features/message-queueing)
    - [Model Temperature](/Roo-Code/features/model-temperature)
    - [Multi-File Reads](/Roo-Code/features/concurrent-file-reads)
    - [.rooignore](/Roo-Code/features/rooignore)
    - [Skills](/Roo-Code/features/skills)
    - [Slash Commands](/Roo-Code/features/slash-commands)
    - [Suggested Responses](/Roo-Code/features/suggested-responses)
    - [Task Todo List](/Roo-Code/features/task-todo-list)
    - [Worktrees](/Roo-Code/features/worktrees)
    - [Terminal Shell Integration](/Roo-Code/features/shell-integration)
    - [Additional Features](/Roo-Code/features/more-features)
  + [MCP](/Roo-Code/features/mcp/overview)
  + [Experimental](/Roo-Code/features/experimental/experimental-features)
  + [Advanced Usage](/Roo-Code/advanced-usage/available-tools/tool-use-overview)
* [Model Providers](/Roo-Code/providers/)
* [Extension Release Notes](/Roo-Code/update-notes/)
* [FAQ](/Roo-Code/faq)
...
## What is Shell Integration?[​](#what-is-shell-integration "Direct link to What is Shell Integration?")
...
* Execute commands on your behalf through the [`execute_command`](/Roo-Code/advanced-usage/available-tools/execute-command) tool
...
## Terminal Integration Settings[​](#terminal-integration-settings "Direct link to Terminal Integration Settings")
...
### Command Execution Timeout Settings[​](#command-execution-timeout-settings "Direct link to Command Execution Timeout Settings")
...
#### `roo-cline.commandExecutionTimeout`[​](#roo-clinecommandexecutiontimeout "Direct link to roo-clinecommandexecutiontimeout")
...
#### `roo-cline.commandTimeoutAllowlist`[​](#roo-clinecommandtimeoutallowlist "Direct link to roo-clinecommandtimeoutallowlist")
...
#### Terminal Output Limit[​](#terminal-output-limit "Direct link to Terminal Output Limit")

![Terminal output limit slider set to 500](/img/shell-integration/shell-integration-13.png)
...
#### Terminal Character Limit[​](#terminal-character-limit "Direct link to Terminal Character Limit")

![Terminal character limit setting](/img/shell-integration/shell-integration-15.png)
...
#### Compress progress bar output[​](#compress-progress-bar-output "Direct link to Compress progress bar output")

![Compress progress bar output checkbox](/img/shell-integration/shell-integration-14.png)
...
#### Use Inline Terminal (recommended)[​](#use-inline-terminal-recommended "Direct link to Use Inline Terminal (recommended)")

![Use Inline Terminal (recommended) switch](/img/shell-integration/shell-integration-16.png)
...
* ON (Use Inline Terminal): Runs commands with the Inline Terminal (in chat), bypassing shell profiles and VS Code shell integration for reliability and faster starts. Mechanism: uses a background “execa” provider and streams output directly (no VS Code OSC 633/133 markers).
  ...
  ![Roo Code Inline Terminal when 'Use Inline Terminal (recommended)' is ON](/img/shell-integration/shell-integration-12.png)
...
#### Decision guide: Inline Terminal ON vs OFF[​](#decision-guide-inline-terminal-on-vs-off "Direct link to Decision guide: Inline Terminal ON vs OFF")
...
#### Inherit environment variables[​](#inherit-environment-variables "Direct link to Inherit environment variables")

![Inherit environment variables checkbox](/img/shell-integration/shell-integration-17.png)
...
#### Terminal shell integration timeout[​](#terminal-shell-integration-timeout "Direct link to Terminal shell integration timeout")

![Terminal shell integration timeout slider set to 15s](/img/shell-integration/shell-integration-18.png)
...
#### Terminal command delay[​](#terminal-command-delay "Direct link to Terminal command delay")

![Terminal command delay slider set to 0ms](/img/shell-integration/shell-integration-19.png)
...
#### Enable PowerShell counter workaround[​](#enable-powershell-counter-workaround "Direct link to Enable PowerShell counter workaround")

![Enable PowerShell counter workaround checkbox](/img/shell-integration/shell-integration-20.png)
...
#### Clear ZSH EOL mark[​](#clear-zsh-eol-mark "Direct link to Clear ZSH EOL mark")

![Clear ZSH EOL mark checkbox](/img/shell-integration/shell-integration-21.png)
...
#### Enable Oh My Zsh integration[​](#enable-oh-my-zsh-integration "Direct link to Enable Oh My Zsh integration")

![Enable Oh My Zsh integration checkbox](/img/shell-integration/shell-integration-22.png)
...
#### Enable Powerlevel10k integration[​](#enable-powerlevel10k-integration "Direct link to Enable Powerlevel10k integration")

![Enable Powerlevel10k integration checkbox](/img/shell-integration/shell-integration-23.png)
...
#### Enable ZDOTDIR handling[​](#enable-zdotdir-handling "Direct link to Enable ZDOTDIR handling")

![Enable ZDOTDIR handling checkbox](/img/shell-integration/shell-integration-24.png)
...
## How Shell Integration Works[​](#how-shell-integration-works "Direct link to How Shell Integration Works")
...
## Troubleshooting Shell Integration[​](#troubleshooting-shell-integration "Direct link to Troubleshooting Shell Integration")

#### Quick fixes[​](#quick-fixes "Direct link to Quick fixes")
...
#### PowerShell Execution Policy (Windows)[​](#powershell-execution-policy-windows "Direct link to PowerShell Execution Policy (Windows)")
...
#### Manual Shell Integration Installation[​](#manual-shell-integration-installation "Direct link to Manual Shell Integration Installation")
...
#### Terminal Customization Issues[​](#terminal-customization-issues "Direct link to Terminal Customization Issues")
...
#### Verifying Shell Integration Status[​](#verifying-shell-integration-status "Direct link to Verifying Shell Integration Status")
...
#### WSL: best-practice setup[​](#wsl-best-practice-setup "Direct link to WSL: best-practice setup")
...
#### Method 1: VS Code Windows with WSL Terminal[​](#method-1-vs-code-windows-with-wsl-terminal "Direct link to Method 1: VS Code Windows with WSL Terminal")
...
#### Method 2: VS Code Running Within WSL[​](#method-2-vs-code-running-within-wsl "Direct link to Method 2: VS Code Running Within WSL")
...
#### Cygwin (bash, zsh)[​](#cygwin-bash-zsh "Direct link to Cygwin (bash, zsh)")
...
#### VS Code Shell Integration for Fish + Cygwin on Windows[​](#vs-code-shell-integration-for-fish--cygwin-on-windows "Direct link to VS Code Shell Integration for Fish + Cygwin on Windows")
...
#### Ctrl+C Behavior[​](#ctrlc-behavior "Direct link to Ctrl+C Behavior")
...
#### Multi-line Command Issues[​](#multi-line-command-issues "Direct link to Multi-line Command Issues")
...
#### PowerShell-Specific Issues[​](#powershell-specific-issues "Direct link to PowerShell-Specific Issues")
...
#### Incomplete Terminal Output[​](#incomplete-terminal-output "Direct link to Incomplete Terminal Output")
...
#### Python Virtual Environment (venv) Issues[​](#python-virtual-environment-venv-issues "Direct link to Python Virtual Environment (venv) Issues")
...
#### Checking Debug Logs[​](#checking-debug-logs "Direct link to Checking Debug Logs")
...
#### Using the VS Code Terminal Integration Test Extension[​](#using-the-vs-code-terminal-integration-test-extension "Direct link to Using the VS Code Terminal Integration Test Extension")
...
* What does “Command Execution Fallback” mean?
  ...
  + Fix: turn ON [Use Inline Terminal (recommended)](#use-inline-terminal-recommended) or follow the Troubleshooting steps above to restore VS Code shell integration.![Command execution fallback notification example](/img/v3.15.0/v3.15.0.png)

[Edit this page](https://github.com/RooCodeInc/Roo-Code/edit/main/apps/docs/docs/features/shell-integration.mdx)

Last updated on **May 15, 2026**

[Previous

Worktrees](/Roo-Code/features/worktrees)[Next

Additional Features](/Roo-Code/features/more-features)

* [What is Shell Integration?](#what-is-shell-integration)
* [Terminal Integration Settings](#terminal-integration-settings)
  + [Command Execution Timeout Settings](#command-execution-timeout-settings)
  + [Basic Settings](#basic-settings)
  + [Advanced Settings](#advanced-settings)
* [How Shell Integration Works](#how-shell-integration-works)
* [Troubleshooting Shell Integration](#troubleshooting-shell-integration)
* [FAQ](#faq)

![Roo Code Logo](/Roo-Code/img/roo-code-logo-dark.svg)![Roo Code Logo](/Roo-Code/img/roo-code-logo-white.svg)

Open-source AI coding assistance for VS Code.

Social

* [Twitter](https://x.com/roocode)
