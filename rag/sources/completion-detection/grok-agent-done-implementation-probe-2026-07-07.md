...
evidence_level: "unit_test_green_168_after_v0.9.1_finalization; real_tui_smoke_green; parallel_smoke_green; immediate_mcp_tools_call_smoke_green; negative_race_security_schema_tests_green"
chars: 6035
---
...
調査日: 2026-07-07  
対象: `aiterm-mcp` 実装、Grok CLI `0.2.87`

Current status (2026-07-07 finalization): this probe is now part of the
released `aiterm-mcp@0.9.1` state. Post-release finalization added the
Codex managed home allowlist hardening and release metadata version-sync test;
the current regression suite is 168 tests.
...
- `npm test`: 167 pass at this probe point; 168 pass after v0.9.1
  finalization and release metadata sync coverage.
