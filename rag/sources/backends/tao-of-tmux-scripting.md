---
title: "Scripting tmux — The Tao of tmux"
source_url: "https://tao-of-tmux.readthedocs.io/en/latest/manuscript/10-scripting.html"
source_type: docs
fetched: 2026-06-01
topic: backends
tags: ["tmux", "scripting", "send-keys", "capture-pane", "targets", "formats", "automation"]
summary: "tmuxのスクリプト制御解説。targets(-t)、formats(-F #{...})、send-keys、capture-pane を使った機械的操作を体系化。"
relevance: "send/read を tmux コマンドへ写像する具体パターン(target解決、format での状態取得)が分かる。薄い層の実装レシピとして直接効く。"
chars: 21766
---

[tao-of-tmux](../index.html)

latest

* [Foreword](00-foreword.html)
* [Thinking in tmux {#thinking-tmux}](01-thinking-tmux.html)
* [Terminal fundamentals {#terminal-fundamentals}](02-terminal-fundamentals.html)
* [Practical usage {#practical-usage}](03-practical-usage.html)
* [Server {#server}](04-server.html)
* [Sessions {#sessions}](05-session.html)
* [Windows {#windows}](06-window.html)
* [Panes {#panes}](07-pane.html)
* [Configuration {#config}](08-configuration.html)
* [Status bar and styling {#status-bar}](09-status-bar.html)
* Scripting tmux {#scripting-tmux}
  + [Aliases {#aliases}](#aliases-aliases)
  + [Pattern matching {#fnmatch}](#pattern-matching-fnmatch)
  + [Targets {#targets}](#targets-targets)
    - [`attach-session [-t target-session]`](#attach-session-t-target-session)
    - [`detach-client [-s target-session] [-t target-client]`](#detach-client-s-target-session-t-target-client)
    - [`has-session [-t target-session]`](#has-session-t-target-session)
    - [`$ tmux kill-session [-t target-session]`](#tmux-kill-session-t-target-session)
    - [`$ tmux list-clients [-t target-session]`](#tmux-list-clients-t-target-session)
    - [`$ tmux lock-client [-t target-client]`](#tmux-lock-client-t-target-client)
    - [`$ tmux lock-session [-t target-session]`](#tmux-lock-session-t-target-session)
    - [`$ tmux new-session [-t target-session]`](#tmux-new-session-t-target-session)
    - [`$ tmux refresh-client [-t target-client]`](#tmux-refresh-client-t-target-client)
    - [`$ tmux rename-session [-t target-session]` session-name](#tmux-rename-session-t-target-session-session-name)
    - [`$ tmux show-messages [-t target-client]`](#tmux-show-messages-t-target-client)
    - [`$ tmux suspend-client [-t target-client]`](#tmux-suspend-client-t-target-client)
    - [`$ tmux switch-client [-c target-client] [-t target-session]`](#tmux-switch-client-c-target-client-t-target-session)
  + [Formats {#formats}](#formats-formats)
  + [Controlling tmux {#send-keys}](#controlling-tmux-send-keys)
  + [Capturing pane content {#capture-pane}](#capturing-pane-content-capture-pane)
  + [Summary](#summary)
* [Tips and tricks {#tips-and-tricks}](11-tips-and-tricks.html)
* [Takeaway {#takeaway}](12-takeaway.html)
* [Appendix: Cheatsheets {#appendix-cheatsheets}](99-cheatsheets.html)
* [Appendix: Installing tmux {#appendix-installation}](99-installation.html)
* [Appendix: tmux on Windows 10 {#appendix-windows-bash}](99-windows-bash.html)
* [Appendix: Troubleshooting {#appendix-troubleshooting}](99-troubleshooting.html)

[tao-of-tmux](../index.html)

* [Docs](../index.html) »
* Scripting tmux {#scripting-tmux}
* [Edit on GitHub](https://github.com/talengu/tao-of-tmux/blob/master/manuscript/10-scripting.md)

---

# Scripting tmux {#scripting-tmux}[¶](#scripting-tmux-scripting-tmux "Permalink to this headline")
...
## Aliases {#aliases}[¶](#aliases-aliases "Permalink to this headline")
...
## Pattern matching {#fnmatch}[¶](#pattern-matching-fnmatch "Permalink to this headline")
...
## Targets {#targets}[¶](#targets-targets "Permalink to this headline")
...
### `attach-session [-t target-session]`[¶](#attach-session-t-target-session "Permalink to this headline")

{language=shell, line-numbers=off}
$ tmux attach-session -t mysession

### `detach-client [-s target-session] [-t target-client]`[¶](#detach-client-s-target-session-t-target-client "Permalink to this headline")
...
### `has-session [-t target-session]`[¶](#has-session-t-target-session "Permalink to this headline")
...
### `$ tmux kill-session [-t target-session]`[¶](#tmux-kill-session-t-target-session "Permalink to this headline")

{language=shell, line-numbers=off}
$ tmux kill-session -t mysession

### `$ tmux list-clients [-t target-session]`[¶](#tmux-list-clients-t-target-session "Permalink to this headline")

{language=shell, line-numbers=off}
$ tmux list-clients -t mysession

### `$ tmux lock-client [-t target-client]`[¶](#tmux-lock-client-t-target-client "Permalink to this headline")

{language=shell, line-numbers=off}
$ tmux lock-clients -t /dev/ttys004

### `$ tmux lock-session [-t target-session]`[¶](#tmux-lock-session-t-target-session "Permalink to this headline")

{language=shell, line-numbers=off}
$ tmux lock-session -t mysession

### `$ tmux new-session [-t target-session]`[¶](#tmux-new-session-t-target-session "Permalink to this headline")
...
### `$ tmux refresh-client [-t target-client]`[¶](#tmux-refresh-client-t-target-client "Permalink to this headline")

{language=shell, line-numbers=off}
$ tmux refresh-client -t /dev/ttys004

### `$ tmux rename-session [-t target-session]` session-name[¶](#tmux-rename-session-t-target-session-session-name "Permalink to this headline")
...
### `$ tmux show-messages [-t target-client]`[¶](#tmux-show-messages-t-target-client "Permalink to this headline")

{language=shell, line-numbers=off}
$ tmux show-messages -t /dev/ttys004

### `$ tmux suspend-client [-t target-client]`[¶](#tmux-suspend-client-t-target-client "Permalink to this headline")
...
### `$ tmux switch-client [-c target-client] [-t target-session]`[¶](#tmux-switch-client-c-target-client-t-target-session "Permalink to this headline")
...
## Formats {#formats}[¶](#formats-formats "Permalink to this headline")
...
{language=shell, line-numbers=off}
$ tmux list-windows -F “#{window\_id} #{window\_name}”
> @0 zsh
...
{language=shell, line-numbers=off}
$ tmux list-panes -F “#{pane\_id} #{pane\_current\_command} #{pane\_current\_path} #{cursor\_x},#{cursor\_y}”
...
{language=shell, line-numbers=off}
$ tmux list-panes -F “pane: #{pane\_id}, window: #{window\_id}, session: #{session\_id}, server: #{socket\_path}”
...
{language=shell, line-numbers=off}
$ tmux list-windows -F “window: #{window\_id}, panes: #{window\_panes} pane\_id: #{pane\_id}”
> window: @15, panes: 1 pane\_id: %40
window: @13, panes: 3 pane\_id: %36
window: @25, panes: 1 pane\_id: %50
...
## Controlling tmux {#send-keys}[¶](#controlling-tmux-send-keys "Permalink to this headline")
...
![../_images/send-keys-cal.png](../_images/send-keys-cal.png)Top-left: Listing panes, Bottom-left: Sending keys to right pane, Right:
Output of cal(1).

## Capturing pane content {#capture-pane}[¶](#capturing-pane-content-capture-pane "Permalink to this headline")
...
![../_images/capture-pane-vim.png](../_images/capture-pane-vim.png)Top-left: Listing panes, Bottom-left: Capturing pane output of top-left pane,
Right: Pasting buffer into vim.
...
and [piping](https://en.wikipedia.org/wiki/Pipeline_%28Unix%29), while maintaining
...
[Next](11-tips-and-tricks.html "Tips and tricks {#tips-and-tricks}")
 [Previous](09-status-bar.html "Status bar and styling {#status-bar}")
