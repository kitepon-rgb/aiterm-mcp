...
source_url: "https://github.com/tmux/tmux/wiki/Getting-Started"
source_type: docs
fetched: 2026-06-01
topic: backends
tags: ["tmux", "client-server", "session", "window", "pane", "attach", "detach", "persistence"]
summary: "tmuxのクライアント/サーバモデル入門。状態を1個のサーバプロセスに集約し、session/window/paneの階層とattach/detachで永続化する仕組み。"
relevance: "エージェントのプロセスが毎回終了してもdetachedでセッションが生き残る前提(サーバ常駐)を公式に裏付ける。バックエンド選定の基礎モデル。"
chars: 66222
---
...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Ftmux%2Ftmux%2Fwiki%2FGetting-Started)
...
Nicholas Marriott edited this page Aug 26, 2025
·
[113 revisions](/tmux/tmux/wiki/Getting-Started/_history)
...
* ![](images/man_tmux.png)[The manual
...
![](images/tmux_status_line_diagram.png)
...
![](images/tmux_command_prompt.png)
...
![](images/tmux_rename_session.png)
...
* Loading
  ...
  + [Getting started](/tmux/tmux/wiki/Getting-Started#getting-started)
  + [About tmux](/tmux/tmux/wiki/Getting-Started#about-tmux)
  + [About this document](/tmux/tmux/wiki/Getting-Started#about-this-document)
  + [Other documentation and help](/tmux/tmux/wiki/Getting-Started#other-documentation-and-help)
  + [Basic concepts](/tmux/tmux/wiki/Getting-Started#basic-concepts)
  + [The tmux server and clients](/tmux/tmux/wiki/Getting-Started#the-tmux-server-and-clients)
  + [Sessions, windows and panes](/tmux/tmux/wiki/Getting-Started#sessions-windows-and-panes)
  + [Summary of terms](/tmux/tmux/wiki/Getting-Started#summary-of-terms)
  + [Using tmux interactively](/tmux/tmux/wiki/Getting-Started#using-tmux-interactively)
  + [Creating sessions](/tmux/tmux/wiki/Getting-Started#creating-sessions)
  + [The status line](/tmux/tmux/wiki/Getting-Started#the-status-line)
  + [The prefix key](/tmux/tmux/wiki/Getting-Started#the-prefix-key)
  + [Help keys](/tmux/tmux/wiki/Getting-Started#help-keys)
  + [Commands and flags](/tmux/tmux/wiki/Getting-Started#commands-and-flags)
  + [The command prompt](/tmux/tmux/wiki/Getting-Started#the-command-prompt)
  + [Attaching and detaching](/tmux/tmux/wiki/Getting-Started#attaching-and-detaching)
  + [Listing sessions](/tmux/tmux/wiki/Getting-Started#listing-sessions)
  + [Killing tmux entirely](/tmux/tmux/wiki/Getting-Started#killing-tmux-entirely)
  + [Creating new windows](/tmux/tmux/wiki/Getting-Started#creating-new-windows)
  + [Splitting the window](/tmux/tmux/wiki/Getting-Started#splitting-the-window)
  + [Changing the current window](/tmux/tmux/wiki/Getting-Started#changing-the-current-window)
  + [Changing the active pane](/tmux/tmux/wiki/Getting-Started#changing-the-active-pane)
  + [Choosing sessions, windows and panes](/tmux/tmux/wiki/Getting-Started#choosing-sessions-windows-and-panes)
  + [Detaching other clients](/tmux/tmux/wiki/Getting-Started#detaching-other-clients)
  + [Killing a session, window or pane](/tmux/tmux/wiki/Getting-Started#killing-a-session-window-or-pane)
  + [Renaming sessions and windows](/tmux/tmux/wiki/Getting-Started#renaming-sessions-and-windows)
  + [Swapping and moving](/tmux/tmux/wiki/Getting-Started#swapping-and-moving)
  + [Resizing and zooming panes](/tmux/tmux/wiki/Getting-Started#resizing-and-zooming-panes)
  + [Window layouts](/tmux/tmux/wiki/Getting-Started#window-layouts)
  + [Copy and paste](/tmux/tmux/wiki/Getting-Started#copy-and-paste)
  + [Finding windows and panes](/tmux/tmux/wiki/Getting-Started#finding-windows-and-panes)
  + [Using the mouse](/tmux/tmux/wiki/Getting-Started#using-the-mouse)
  + [Configuring tmux](/tmux/tmux/wiki/Getting-Started#configuring-tmux)
  + [The configuration file](/tmux/tmux/wiki/Getting-Started#the-configuration-file)
  + [Key bindings](/tmux/tmux/wiki/Getting-Started#key-bindings)
  + [Copy mode key bindings](/tmux/tmux/wiki/Getting-Started#copy-mode-key-bindings)
  + [Types of option](/tmux/tmux/wiki/Getting-Started#types-of-option)
  + [Showing options](/tmux/tmux/wiki/Getting-Started#showing-options)
  + [Changing options](/tmux/tmux/wiki/Getting-Started#changing-options)
  + [Formats](/tmux/tmux/wiki/Getting-Started#formats)
  + [Embedded commands](/tmux/tmux/wiki/Getting-Started#embedded-commands)
  + [Colours and styles](/tmux/tmux/wiki/Getting-Started#colours-and-styles)
  + [Embedded styles](/tmux/tmux/wiki/Getting-Started#embedded-styles)
  + [List of useful options](/tmux/tmux/wiki/Getting-Started#list-of-useful-options)
  + [List of style and format options](/tmux/tmux/wiki/Getting-Started#list-of-style-and-format-options)
  + [Common configuration changes](/tmux/tmux/wiki/Getting-Started#common-configuration-changes)
  + [Changing the prefix key](/tmux/tmux/wiki/Getting-Started#changing-the-prefix-key)
  + [Customizing the status line](/tmux/tmux/wiki/Getting-Started#customizing-the-status-line)
  + [Configuring the pane border](/tmux/tmux/wiki/Getting-Started#configuring-the-pane-border)
  + [vi(1) key bindings](/tmux/tmux/wiki/Getting-Started#vi1-key-bindings)
  + [Mouse copying behaviour](/tmux/tmux/wiki/Getting-Started#mouse-copying-behaviour)
  + [Other features](/tmux/tmux/wiki/Getting-Started#other-features)
* Loading
