...
> **v0.21.2 release candidate（2026-08-03）**: Codexの完了正本をmanaged Stop hookからroot rollout
...
> `docs/22_release-0.21.2-plan.md`を正とする。v0.21.1 tag CIはGrok fixtureが実CLIを暗黙利用して
> clean runnerで失敗し、publish jobはskipされた。tagを動かさず、偽binへ固定した0.21.2で公開する。
...
> v0.21.2でreceipt欠陥、4 manifest、公開連鎖を再同期し、0.21.0の公開面分裂を解消する。
...
> **2026-08-03 v0.21.2設計**: Codex完了正本をmanaged Stop hookからroot rollout transcriptの
